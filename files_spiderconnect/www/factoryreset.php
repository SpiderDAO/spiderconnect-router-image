                    ...
                    <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                        ...
                        <div class="remote-form">
                            <div class="remote-head remote-head-1">
                                <h3>Factory Reset <br>'.file_get_contents("/brand/brand.txt").'?</h3>
                            </div>
                            <div class="remote-form-inn">
                                <ul class="mod-list-btn mod-list-blcok">
                                    <li><a onclick="return ConfirmFactoryReset()" href="/api/restart.php?factoryreset=1">Factory Reset</a></li>
