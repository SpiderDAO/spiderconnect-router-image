...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($GHZ5EXIST)) {
        ...
        exec(
            "uci set wireless.@wifi-iface[$GHZ5].ssid='" . $_POST['ssid5'] . "'"
        );
        exec(
            "uci set wireless.@wifi-iface[$GHZ5].key='" .
                $_POST['password5'] .
                "'"
        );
        ...
        exec(
            "uci set wireless.@wifi-device[$GHZ5].channel='" .
                $_POST['channel58'] .
                "'"
        );
        ...
        } elseif ($_POST['width58'] == "VHT80") {
            exec("uci set wireless.radio$GHZ5.htmode='VHT80'");
            exec("uci set wireless.radio$GHZ5.noscan='1'");
        } elseif ($_POST['width58'] == "auto") {
            exec("uci set wireless.radio$GHZ5.htmode='VHT80'");
            exec("uci set wireless.radio$GHZ5.noscan='0'");
        } else {
            exec(
                "uci set wireless.radio$GHZ5.htmode='" . $_POST['width58'] . "'"
            );
            exec("uci set wireless.radio$GHZ5.noscan='0'");
        }
        ...
        exec(
            "uci set wireless.@wifi-iface[$GHZ2].ssid='" . $_POST['ssid2'] . "'"
        );
        exec(
            "uci set wireless.@wifi-iface[$GHZ2].key='" .
                $_POST['password2'] .
                "'"
        );
        ...
        exec(
            "uci set wireless.@wifi-device[$GHZ2].channel='" .
                $_POST['channel24'] .
                "'"
        );
        ...
        } elseif ($_POST['width24'] == "auto") {
            exec("uci set wireless.radio$GHZ2.htmode='HT40'");
            exec("uci set wireless.radio$GHZ2.noscan='0'");
        } else {
            exec(
                "uci set wireless.radio$GHZ2.htmode='" . $_POST['width24'] . "'"
            );
            exec("uci set wireless.radio$GHZ2.noscan='0'");
        }
    } else {
        ...
        exec(
            "uci set wireless.@wifi-iface[0].key='" . $_POST['password2'] . "'"
        );
        ...
        exec(
            "uci set wireless.@wifi-device[0].channel='" .
                $_POST['channel24'] .
                "'"
        );
